...
aws s3 mb s3://emre-cli-bucket

aws s3 cp in-class.yaml s3://emre-cli-bucket

aws s3 ls s3://emre-cli-bucket

aws s3 rm s3://emre-cli-bucket/in-class.yaml

aws s3 rb s3://emre-cli-bucket
